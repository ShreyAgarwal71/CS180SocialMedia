...
CS180SocialMedia is a Java-based backend simulation for a simple social media platform. It contains for basic user management, posting, and commenting, with data persistence through the use of a file storing system. This project is built with Maven and includes Java classes for users, posts, comments, and images.
